      ...
      while ($row = $result->fetch_assoc()) {
        ...
        <tr>
          ...
          <td><button class="btn btn-custom-edit" style="height:40px"
              onclick="clientEditForm('<?= $row['client_id'] ?>')">Edit</button></td>
          <td><button class="btn btn-custom-delete" style="height:40px"
              onclick="clientDelete('<?= $row['client_id'] ?>')">Delete</button></td>
        </tr>
        ...
        <div class="modal-body">
          <form onsubmit="addClient()" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="client_surname" required>
            </div>
            <div class="form-group">
              <label for="client_patronymic">Client Patronymic:</label>
              <input type="text" class="form-control" id="client_patronymic" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="client_address" required>
            </div>
            <div class="form-group">
              <button type="submit" class="btn btn-secondary" style="height:40px">Add Client</button>
            </div>
          </form>
        </div>
